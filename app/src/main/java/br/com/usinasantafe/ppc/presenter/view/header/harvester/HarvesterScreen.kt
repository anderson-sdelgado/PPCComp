...
fun HarvesterScreen(
    ...
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ...
            HarvesterContent(
                nroHarvester = uiState.nroHarvester,
...
fun HarvesterContent(
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = R.string.text_title_harvester
            )
        )
        OutlinedTextField(
...
@Preview(showBackground = true)
@Composable
fun HarvesterPagePreviewUpdate() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            HarvesterContent(
                nroHarvester = "250",
...
@Preview(showBackground = true)
@Composable
fun HarvesterPagePreviewUpdateSuccess() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            HarvesterContent(
                nroHarvester = "250",
...
@Preview(showBackground = true)
@Composable
fun HarvesterPagePreviewFieldEmpty() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            HarvesterContent(
                nroHarvester = "250",
...
@Preview(showBackground = true)
@Composable
fun HarvesterPagePreviewInvalid() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            HarvesterContent(
                nroHarvester = "250",
...
@Preview(showBackground = true)
@Composable
fun HarvesterPagePreviewFailure() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            HarvesterContent(
                nroHarvester = "250",
