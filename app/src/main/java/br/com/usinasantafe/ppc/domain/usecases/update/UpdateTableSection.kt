...
class IUpdateTableSection @Inject constructor(
    ...
    override suspend fun invoke(
        ...
        val resultRecoverAll = sectionRepository.listAll(token)
        ...
        val resultDeleteAll = sectionRepository.deleteAll()
        ...
        val resultAddAll = sectionRepository.addAll(entityList)
