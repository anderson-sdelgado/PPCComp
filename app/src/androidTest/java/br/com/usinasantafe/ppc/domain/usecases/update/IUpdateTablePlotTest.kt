...
class IUpdateTablePlotTest {
    ...
    @Inject
    lateinit var usecase: UpdateTablePlot
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePlot -> IGetToken -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePlot -> IPlotRepository.listAll -> IPlotRetrofitDatasource.listAll -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePlot -> IPlotRepository.listAll -> IPlotRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePlot -> IPlotRepository.listAll -> IPlotRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
