...
fun SectionContent(
    ...
    Column(
        ...
        TitleDesign(
            text = stringResource(
                id = R.string.text_title_section
            )
        )
        OutlinedTextField(
...
@Preview(showBackground = true)
@Composable
fun SectionPagePreviewUpdateSuccess() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SectionContent(
                nroSection = "200",
...
@Preview(showBackground = true)
@Composable
fun SectionPagePreviewFieldEmpty() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SectionContent(
                nroSection = "200",
...
@Preview(showBackground = true)
@Composable
fun SectionPagePreviewFieldInvalid() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SectionContent(
                nroSection = "200",
