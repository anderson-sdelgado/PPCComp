...
fun OperatorScreen(
    ...
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ...
            OperatorContent(
                regOperator = uiState.regOperator,
...
@Preview(showBackground = true)
@Composable
fun OperatorPagePreviewUpdateSuccess() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            OperatorContent(
                regOperator = "19759",
...
@Preview(showBackground = true)
@Composable
fun OperatorPagePreviewFieldEmpty() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            OperatorContent(
                regOperator = "19759",
...
@Preview(showBackground = true)
@Composable
fun OperatorPagePreviewInvalid() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            OperatorContent(
                regOperator = "19759",
...
@Preview(showBackground = true)
@Composable
fun OperatorPagePreviewFailure() {
    PPCTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            OperatorContent(
                regOperator = "19759",
